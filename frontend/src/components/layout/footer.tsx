...
export default function Footer({ }: Props) {
  return (
    <footer className="border-t border-t-slate-200">
      <div className="container flex flex-col md:flex-row md:flex-wrap justify-center items-center py-12 gap-x-6">
        ...
        <div className="h-2 md:h-6 md:border-s-2 md:border-s-slate-200"></div>
