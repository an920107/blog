...
use crate::framework::web::{
    delete_image_handler::delete_image_handler, get_image_by_id_handler::get_image_by_id_handler,
    get_image_info_handler::get_image_info_handler, list_images_handler::list_images_handler,
